...
namespace VibeWave.DataAccess.Migrations
{
    ...
    [Migration("20260526005423_AddSubmittedAtAndIsReadToContactMessage")]
    partial class AddSubmittedAtAndIsReadToContactMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VibeWave.Models.Concert", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DisplayDate = new DateOnly(2026, 6, 10),
                        ...
                        new
                        {
                            ...
                            DisplayDate = new DateOnly(2026, 6, 12),
                            DisplayTime = new TimeOnly(0, 20, 0),
                            TicketPrice = 50m
                        },
                        new
            ...
            modelBuilder.Entity("VibeWave.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VibeWave.Models.Payment", b =>
                {
                    b.HasOne("VibeWave.Models.Booking", "Booking")
                        .WithMany()
